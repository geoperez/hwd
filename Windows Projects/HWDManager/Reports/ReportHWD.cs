...
namespace HWD
{
	public class ReportHWD : IReportMaker
	{
		...
		public void MakeDocument(ReportDocument reportDocument)
		{
			...
			builder.AddColumn("Manufacturer", "Manufacturer", 2.1f, false, true);
			builder.AddColumn("Model", "Model", 2f, false, true);
			builder.AddColumn("SerialNumber", "Serial Number", 2f, false, true);
