...
namespace HWD
{
	class Utilities
	{
		...
		public static void ChecaTablas(SqlConnection conn)
		{
			...
			try
			{
				comm.CommandText ="Select 1 from HWD_SYSTEMS";
				comm.ExecuteNonQuery();
			}
			catch
			{

				sb.Append("CREATE TABLE [HWD_SYSTEMS] (\r\n");
			...
			try
			{
				comm.CommandText ="Select 1 from HWD_KINDS";
				comm.ExecuteNonQuery();
			}
			catch
			{	
				sb.Append("CREATE TABLE [HWD_KINDS] (\r\n");
			...
			try
			{
				comm.CommandText ="Select 1 from HWD_LOCATIONS";
				comm.ExecuteNonQuery();
			}
			catch
			{
				sb.Append("CREATE TABLE [HWD_LOCATIONS] (\r\n");
