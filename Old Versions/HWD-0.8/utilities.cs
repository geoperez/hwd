...
namespace HWD
{
	class Utilities
	{
		...
		public static void ChecaTablas(SqlConnection conn)
		{
			...
			try
			{
				comm.CommandText ="Select 1 from swd";
				comm.ExecuteNonQuery();
			}
			catch
			{
			    
				sb.Append("CREATE TABLE [SWD] (\r\n");
				sb.Append("	[ID] [int] IDENTITY (1, 1) NOT NULL ,\r\n");
				sb.Append("	[ComputerName] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL ,\r\n");
				sb.Append("	[SoftwareName] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL ,\r\n");
				sb.Append("	[Version] [char] (20) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ,\r\n");
				sb.Append("	[Vendor] [char] (20) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ,\r\n");
				sb.Append("	CONSTRAINT [PK_SWD] PRIMARY KEY  CLUSTERED \r\n");
				sb.Append("	(\r\n");
				sb.Append("		[ID]\r\n");
				sb.Append("	)  ON [PRIMARY] \r\n");
				sb.Append(") ON [PRIMARY]\r\n");
